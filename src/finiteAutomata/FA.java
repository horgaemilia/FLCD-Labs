                ...
                switch (mode) {
                    ...
                    case "Transitions" -> {
                        ...
                        if (transitionElements.length == 3) {
                            ...
                            String[] allAlphabetElements = alphabetElement.split(",");
                            String to = transitionElements[2];
                            to = to.replaceAll("\\s+","");
                            for(int i=0;i<allAlphabetElements.length;i++)
                            {
                                Transition transition = new Transition(from, allAlphabetElements[i], to);
